...
export default async function handler(request, response) {
  if (request.method === "GET" && request.query?.health === "1") {
    ...
    if (!configured.database) {
      return json(response, 503, {
        ready: false,
        message: "Οι εγγραφές θα ανοίξουν μόλις ολοκληρωθεί η ασφαλής σύνδεση της βάσης.",
        configured,
      });
    }
  ...
  if (!configured.database) {
    return json(response, 503, {
      message: "Η ασφαλής βάση εγγραφών δεν είναι διαθέσιμη. Παρακαλούμε δοκιμάστε αργότερα.",
    });
  }
  ...
  try {
    ...
    return json(response, 400, { message: "Τα δεδομένα της φόρμας δεν είναι έγκυρα." });
  }
    ...
    return json(response, 201, {
      message: participantEmailSent
        ...
        : configured.email
          ...
          : "Η εγγραφή σας αποθηκεύτηκε επιτυχώς. Η επιβεβαίωση email δεν έχει ενεργοποιηθεί ακόμη.",
